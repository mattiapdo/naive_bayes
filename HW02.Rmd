...
#Plot the classees of the training data

```{r}
library(scatterplot3d)

colors <- c("#999999", "#E69F00")
colors <- colors[as.numeric(ds.train$id)]
scatterplot3d(ds.train[,2:4],
              main="3D Scatter Plot on Training Set",
              xlab = "RLxMag",
              ylab = "RLyMag",
              zlab = "RLzMag",color=colors)
sc <- scatterplot3d(ds.train[,2:4], pch = 16, color=colors)
legend(sc$xyz.convert(2, 2, 0), legend = levels(ds.train$id),
